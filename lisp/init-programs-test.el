...
(use-package counsel
  ...
  :config
  (global-set-key (kbd "A-p p") #'counsel-M-x)
  (global-set-key (kbd "A-f") #'counsel-grep-or-swiper)
...
(use-package projectile
  ...
  (define-key projectile-mode-map (kbd "C-S-f") #'projectile-ripgrep) ; counsel
...
;;; init-programs-test.el ends here