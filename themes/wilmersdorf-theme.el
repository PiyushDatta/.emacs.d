...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(company-preview-common ((t (:foreground unspecified :background "#33373E"))))
   `(company-scrollbar-bg ((t (:background "#33363a"))))
   `(company-scrollbar-fg ((t (:background "#6a7488"))))
   `(company-tooltip ((t (:inherit default :background "#33363a"))))
   ...
   `(ido-subdir ((,class (:weight bold :foreground "#eeeeee"))))
   ...
   `(centaur-tabs-selected ((t (:background ,bg1 :foreground "white" :box nil))))
   `(centaur-tabs-unselected ((t (:background ,bg0 :foreground ,fg3 :box nil))))
   `(centaur-tabs-selected-modified ((t (:background ,bg1 :foreground ,"#c9d9ff" :box nil))))
